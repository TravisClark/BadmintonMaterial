...
namespace WebApplication2.Controllers
{
    public class DonHangController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,product_id,customer_id,date,status,total_money")] DonHang donHang)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,product_id,customer_id,date,status,total_money")] DonHang donHang)
        {
            if (ModelState.IsValid)
            {
